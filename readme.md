...
A text-based RPG game, where the goal is to clear the 50 rooms and get to the treasure, where they will be presented with the flag. In each room there are 2 doors, one leading closer to the Beacon and one leading to the Lake of Pseudo-Random Fire (i.e. instant death). To win, they must correctly choose the right door 50 times in a row. The correct door will be the door which emits a fully random response to utterances made by Orycull, while the wrong door will be the door which emits a pseudorandom response to utterances made by Orycull. For those who have taken a theoretical cryptography class, you may notice that this game is very similar to the PRF game. This is intentional - it is why the game is called "The Lake of **P**seudo-**R**andom **F**ire". 
